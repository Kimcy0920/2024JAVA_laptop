...
public class Main {
	public static void main(String[] args) {
		...
		Transcript t1 = new Transcript(c1, s1, "2024/2학기", "A"); // 자바 민수
		Transcript t2 = new Transcript(c1, s2, "2024/2학기", "B+"); // 자바 길동
		Transcript t3 = new Transcript(c2, s1, "2024/2학기", "A+"); // C/C++ 민수
		...
		System.out.println("---------------------------");
		System.out.println("길동의 성적기록");
		for(Transcript transcript : s2.getTranscripts()) {
			System.out.print(transcript.getCourse().getName()+": ");
			System.out.println(transcript.getGrade());
		}
